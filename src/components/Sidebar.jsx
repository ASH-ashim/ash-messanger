...
const Sidebar = () => {
    ...
    return (
        <div className={`bg-[#191925]/95 h-full max-h-screen flex flex-col border-r border-white/5 text-white transition-colors duration-200 overflow-hidden ${selectedUser || selectedGroup ? "max-md:hidden" : "w-full md:w-[320px] lg:w-[350px] 2xl:w-[450px]"}`}>
            {/* Header */}
                                    ...
                                    <div className="space-y-1">
                                        {filteredGroups.map((group) => (
                                            <div
                                                ...
                                                key={group._id}
                                                className={`flex items-center gap-3.5 p-3 rounded-2xl cursor-pointer transition-colors duration-200 group ${selectedGroup?._id === group._id ? 'bg-violet-600' : 'hover:bg-white/5'}`}
                                            >
